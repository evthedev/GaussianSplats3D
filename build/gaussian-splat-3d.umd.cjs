(function (global, factory) {
    ...
    class Viewer {
        ...
        constructor(rootElement = null, cameraUp = [0, 1, 0], initialCameraPos = [0, 10, 15], initialCameraLookAt = [0, 0, 0],
            ...
            this.scene = null;
            this.camera = null;
            this.realProjectionMatrix = new THREE__namespace.Matrix4();
            this.renderer = null;
        ...
        init() {
            ...
            this.camera = new THREE__namespace.PerspectiveCamera(70, renderDimensions.x / renderDimensions.y, 0.1, 500);
        ...
        addDebugMeshesToScene(renderOrder) {
            ...
            let sphereMesh = new THREE__namespace.Mesh(sphereGeometry, new THREE__namespace.MeshBasicMaterial({color: 0xff0000}));
            sphereMesh.renderOrder = renderOrder;
            debugMeshRoot.add(sphereMesh);
            sphereMesh.position.set(-50, 0, 0);

            sphereMesh = new THREE__namespace.Mesh(sphereGeometry, new THREE__namespace.MeshBasicMaterial({color: 0xff0000}));
            sphereMesh.renderOrder = renderOrder;
            debugMeshRoot.add(sphereMesh);
            sphereMesh.position.set(50, 0, 0);

            sphereMesh = new THREE__namespace.Mesh(sphereGeometry, new THREE__namespace.MeshBasicMaterial({color: 0x00ff00}));
            sphereMesh.renderOrder = renderOrder;
            debugMeshRoot.add(sphereMesh);
